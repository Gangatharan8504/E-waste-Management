...
const analyzeDeviceImage = async (filePath, deviceHint = 'Laptop') => {
  ...
  const getMockReport = (isElectronic) => {
    ...
    return {
      ...
      repairRecommendation: "Screen/casing damage is severe; repair is not economically viable.",
      aiRepairRecommendation: "Screen/casing damage is severe; repair is not economically viable.",
      reuseRecommendation: "Not suitable for direct reuse; parts extraction suggested.",
  ...
  try {
    ...
    const systemPrompt = `
      ...
      You must respond with a JSON object containing the following keys:
      {
        ...
        "estimatedCondition": "string (e.g. Good, Fair, Poor)",
        "isDamaged": boolean,
